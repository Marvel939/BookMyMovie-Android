<h2 align="center">BookMyMovie Roles & Components Matrix</h2>

<p align="center">
  Because generating text inside a `.png` image often results in blurry or incorrect spellings, I have built this exactly matching your requested colored image style using <b>pure HTML</b>. This means it will render gorgeously as a colorful table inside any Markdown viewer (GitHub, Notion, Obsidian), but the text remains perfectly selectable, searchable, and editable by you!
</p>

<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse; text-align: center; width: 100%; font-family: 'Segoe UI', Arial, sans-serif; background-color: #f8f9fa;">
  
<!-- Header Row 1: Orange -->
  <tr>
    <th colspan="4" style="background-color: #ff9800; color: black; padding: 15px; font-size: 22px; font-weight: bold; border: 1px solid #666;">
